...
export interface LastLineDetails {
  line_number: number;
  page_number: number;
  description: string;
  quantity: number;
...
export interface DocumentExtractionStats {
  ...
  items_by_page: { [key: string]: number };
  last_line_details: LastLineDetails | null;
  total_pages: number;
}

export interface ExtractionSummary {
  document1: DocumentExtractionStats;
  document2: DocumentExtractionStats;
}
